...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/invoiceShow.css">
...
<div class="w3-top">
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    <a href='/InvoiceTracker/' class="w3-bar-item w3-button w3-wide"><i class="fa fa-home"></i>HOME</a>
                ...
                <p> &nbsp;</p>
                 <div class="col-md-6">Amount Received?</div>
                 <div class="col-md-6">${n.invoiceState }</div>
